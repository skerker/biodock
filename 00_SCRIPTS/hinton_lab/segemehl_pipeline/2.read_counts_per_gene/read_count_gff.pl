...
# Syntax: perl reads_each_gene.pl annotation.input UNI_mapped_reads.input > condition.txt
...
#Get mapped reads information form file and calculater no of overlapped reads for a particular gene and store the information into a new hash. 	
