#  ---------------------------------------------------------------------------
#
#  Description:  This is the BASH configuration for the BioDock container
#
#  Sections:
...
#   export PATH="$PATH:/usr/bin/"
    export PATH="/opt/00_SCRIPTS/SCRIPT_bin/:$PATH"
...
alias DT='tee /SCRATCH/terminalOut.txt'     # DT:           Pipe content to file in scratch
